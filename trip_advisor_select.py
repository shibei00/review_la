...
if __name__=='__main__':
    ...
    sql = 'select member_id, count(*) from ' + new_table_name + ' group by member_id where having count(*) < ' + member_threshold
    sql2 = 'select product_id, count(*) from ' + new_table_name + ' group by product_id where having count(*) < ' + product_threshold
