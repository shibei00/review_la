...
if __name__=='__main__':
    ...
    print 'CS_non: %f, %f' %(mu_CS_non, gema_CS_non)
    print 'CS_spam: %f, %f' %(mu_CS_spam, gema_CS_spam)
    mu_MNR_non, gema_MNR_non = get_mean_variance(MNR_list_non)
    mu_MNR_spam, gema_MNR_spam = get_mean_variance(MNR_list_spam)
    print 'MNR_non: %f, %f' %(mu_MNR_non, gema_MNR_non)
    print 'MNR_spam: %f, %f' %(mu_MNR_spam, gema_MNR_spam)
    mu_BST_non, gema_BST_non = get_mean_variance(BST_list_non)
    mu_BST_spam, gema_BST_spam = get_mean_variance(BST_list_spam)
    print 'BST_non: %f, %f' %(mu_BST_non, gema_BST_non)
    print 'BST_spam: %f, %f' %(mu_BST_spam, gema_BST_spam)
    mu_RFR_non, gema_RFR_non = get_mean_variance(RFR_list_non)
    mu_RFR_spam, gema_RFR_spam = get_mean_variance(RFR_list_spam)
    print 'RFR_non: %f, %f' %(mu_RFR_non, gema_RFR_non)
    print 'RFR_spam: %f, %f' %(mu_RFR_spam, gema_RFR_spam)
