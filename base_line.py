    ...
    for i in xrange(0, n_max):
        ...
        for j in member_list:
            for k in member_review_dict[j]:
                ...
                prob_non = first_factor_non *  sf_DUP_non * sf_EXT_non * sf_DEV_non * sf_ETF_non * sf_RA_non * td_CS_non
                ...
                prob_spam = first_factor_spam * sf_DUP_spam * sf_EXT_spam * sf_DEV_spam * sf_ETF_spam * sf_RA_spam * td_CS_spam
