        ...
        for j in member_list:
            for k in member_review_dict[j]:
                if review_label_list[k]==0:
                    ...
                    if r_RA_dict[k]==1:
                        r_spam_is_RA_count -= 1
                first_factor_non= (n_m_non_dict[j] + 3) / float(n_m_count[j] -1 + 4)
                first_factor_spam = (n_m_spam_dict[j] + 1) / float(n_m_count[j] - 1 + 4)
                ...
                prob_non = sf_DUP_non * sf_EXT_non * sf_DEV_non * sf_ETF_non * sf_RA_non * td_CS_non * td_MNR_non
                ...
                prob_spam = sf_DUP_spam * sf_EXT_spam * sf_DEV_spam * sf_ETF_spam * sf_RA_spam * td_CS_spam * td_MNR_spam
